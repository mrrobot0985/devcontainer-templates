...
Custom dev container templates for AI coding agents (Claude + Ollama, Layer B agent entry points, multi-agent, and domain stacks).
...
This repository includes 15 templates:

| Template                    | Description                                                                                            | Version                                                                       | README                                            |
| --------------------------- | ------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ------------------------------------------------- |
| `cloud-native-k8s`          | Devcontainer template for cloud-native development with Kubernetes. Includes kubectl, Helm, k3d, ...   | ![Version](https://img.shields.io/badge/version-1.1.0-blue?style=flat-square) | [README](src/cloud-native-k8s/README.md)          |
| `codex-cli`                 | Minimal devcontainer for OpenAI Codex CLI with container firewall (codex tags), non-root enforcer,...  | ![Version](https://img.shields.io/badge/version-1.0.0-blue?style=flat-square) | [README](src/codex-cli/README.md)                 |
| `data-engineering-spark`    | Devcontainer template for data engineering with Apache Spark 3.5, Jupyter, Polars, MinIO, and own...   | ![Version](https://img.shields.io/badge/version-1.1.0-blue?style=flat-square) | [README](src/data-engineering-spark/README.md)    |
| `gemini-cli`                | Minimal devcontainer for Google Gemini CLI with container firewall (gemini tags), non-root enforce...  | ![Version](https://img.shields.io/badge/version-1.0.0-blue?style=flat-square) | [README](src/gemini-cli/README.md)                |
...
| `hermes-agent`              | Minimal devcontainer for the Hermes agent (Nous Research) with container firewall (openrouter + gi...  | ![Version](https://img.shields.io/badge/version-1.0.0-blue?style=flat-square) | [README](src/hermes-agent/README.md)              |
| `multi-ai-cli`              | Devcontainer template bundling Claude Code, OpenAI Codex CLI, Google Gemini CLI, and OpenCode CLI...   | ![Version](https://img.shields.io/badge/version-1.1.0-blue?style=flat-square) | [README](src/multi-ai-cli/README.md)              |
...
| `opencode-cli`              | Minimal devcontainer for OpenCode CLI with container firewall (github + npm + OpenCode domains), n...  | ![Version](https://img.shields.io/badge/version-1.0.0-blue?style=flat-square) | [README](src/opencode-cli/README.md)              |
| `pi-coding-agent`           | Minimal devcontainer for the Pi coding agent (pi.dev) with container firewall, non-root enforcer,...   | ![Version](https://img.shields.io/badge/version-1.0.0-blue?style=flat-square) | [README](src/pi-coding-agent/README.md)           |
