...
| `multi-ai-cli`              | Layer C multi-agent evaluation workspace (Claude, Grok, Pi, Hermes, Codex, Gemini, OpenCode)...      | ![Version](https://img.shields.io/badge/version-1.1.0-blue?style=flat-square) | [README](src/multi-ai-cli/README.md)              |
