...
The portfolio layers (Claude depth, agent entry points, multi-agent evaluation, kept domain stacks) are defined in [Template Portfolio](template-portfolio.md). This document explains **how** templates are designed inside that portfolio.
